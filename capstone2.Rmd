...
#Bus_Jan_2018 <- read_excel("/Users/chizhang/Downloads/Bus_2018.xlsx", sheet = 1)
#Bus_Feb_2018 <- read_excel("/Users/chizhang/Downloads/Bus_2018.xlsx", sheet = 2)
#Bus_Mar_2018 <- read_excel("/Users/chizhang/Downloads/Bus_2018.xlsx", sheet = 3)
#Bus_April_2018 <- read_excel("/Users/chizhang/Downloads/Bus_2018.xlsx", sheet = 4)
#Bus_May_2018 <- read_excel("/Users/chizhang/Downloads/Bus_2018.xlsx", sheet = 5)
#Bus_June_2018 <- read_excel("/Users/chizhang/Downloads/Bus_2018.xlsx", sheet = 6)
#Bus_July_2018 <- read_excel("/Users/chizhang/Downloads/Bus_2018.xlsx", sheet = 7)
#Bus_Aug_2018 <- read_excel("/Users/chizhang/Downloads/Bus_2018.xlsx", sheet = 8)
#Bus <- rbind(Bus_Jan_2018,Bus_Feb_2018,Bus_Mar_2018,Bus_April_2018,Bus_May_2018,
#             Bus_June_2018,Bus_July_2018,Bus_Aug_2018)

#Streetcar_Jan_2018 <- read_excel("/Users/chizhang/Downloads/Streetcar_2018.xlsx", sheet = 1)
#Streetcar_Feb_2018 <- read_excel("/Users/chizhang/Downloads/Streetcar_2018.xlsx", sheet = 2)
#Streetcar_Mar_2018 <- read_excel("/Users/chizhang/Downloads/Streetcar_2018.xlsx", sheet = 3)
#Streetcar_April_2018 <- read_excel("/Users/chizhang/Downloads/Streetcar_2018.xlsx", sheet = 4)
#Streetcar_May_2018 <- read_excel("/Users/chizhang/Downloads/Streetcar_2018.xlsx", sheet = 5)
#Streetcar_June_2018 <- read_excel("/Users/chizhang/Downloads/Streetcar_2018.xlsx", sheet = 6)
#Streetcar_July_2018 <- read_excel("/Users/chizhang/Downloads/Streetcar_2018.xlsx", sheet = 7)
#Streetcar_Aug_2018 <- read_excel("/Users/chizhang/Downloads/Streetcar_2018.xlsx", sheet = 8)
#Streetcar <- rbind(Streetcar_Jan_2018,Streetcar_Feb_2018,Streetcar_Mar_2018,
#                   Streetcar_April_2018,Streetcar_May_2018,Streetcar_June_2018,
#                   Streetcar_July_2018,Streetcar_Aug_2018)

#Subway_Jan_2018 <- read_excel("/Users/chizhang/Downloads/Subway_SRT_Logs_January_2018.xlsx", sheet = 1)
#Subway_Feb_2018 <- read_excel("/Users/chizhang/Downloads/Subway_SRT_Logs_February_2018.xlsx", sheet = 1)
#Subway_Mar_2018 <- read_excel("/Users/chizhang/Downloads/Subway_SRT_Logs_March_2018.xlsx", sheet = 1)
#Subway_April_2018 <- read_excel("/Users/chizhang/Downloads/Subway_SRT_Logs_April_2018.xlsx", sheet = 1)
#Subway_May_2018 <- read_excel("/Users/chizhang/Downloads/Subway_SRT_Logs_May_2018.xlsx", sheet = 1)
#Subway_June_2018 <- read_excel("/Users/chizhang/Downloads/Subway_SRT_Logs_June_2018.xlsx", sheet = 1)
#Subway_July_2018 <- read_excel("/Users/chizhang/Downloads/Subway_SRT_Logs_July_2018.xlsx", sheet = 1)
#Subway_Aug_2018 <- read_excel("/Users/chizhang/Downloads/Subway_SRT_Logs_August_2018.xlsx", sheet = 1)
#Subway <- rbind(Subway_Jan_2018,Subway_Feb_2018,Subway_Mar_2018,
#                   Subway_April_2018,Subway_May_2018,Subway_June_2018,
#                   Subway_July_2018,Subway_Aug_2018)
# write.csv(Subway, "/Users/chizhang/Downloads/Subway.csv", row.names=T)
 Subway<- file.choose()
...
### We focus on subway data. 

#Streetcar <- kNN(Streetcar,k = 5)
#Streetcar <- Streetcar[, 1:10]

#Bus <- kNN(Bus,k = 5) # about 7 min runtime on my mac
#Bus <- Bus[, 1:10]
...
registerDoParallel(cl1)
  ...
  rmse_svm_full<-rmse(test_Subway_full$Min_Gap, predict_svm_full) #12.09735, 9.419213, 12.27894, 12.22133, 12.04951, 9.823341
  mae_svm_full<-mae(test_Subway_full$Min_Gap, predict_svm_full)#3.460279, 3.297153, 3.355789, 3.526779, 3.527625, 3.328808
  rmse_svm_full
  mae_svm_full
  ...
  rmse_lm_full<-rmse(test_Subway_full$Min_Gap, predict_lm_full) #11.25564, 8.638787, 11.59239, 11.27407, 11.29387, 9.028127
  mae_lm_full<-mae(test_Subway_full$Min_Gap, predict_lm_full)# 4.077022, 3.913723, 3.943498, 4.211941, 4.204957, 3.953407
  rmse_lm_full
  mae_lm_full
  ...
  rmse_rf_full<-rmse(test_Subway_full$Min_Gap, predict_rf_full)# 10.97945, 8.266417, 11.36282,  11.17688, 11.36434, 8.687817
  mae_rf_full<-mae(test_Subway_full$Min_Gap, predict_rf_full)# 3.638745, 3.435454,3.77924, 3.79786, 3.840957, 3.480622
  rmse_rf_full
  mae_rf_full
...
rmse_ens_full<-rmse(test_Subway_full$Min_Gap, predict_ens_full) #11.87939, 9.291069, 11.55512, 11.97087, 11.91217, 9.621718
mae_ens_full<-mae(test_Subway_full$Min_Gap, predict_ens_full)#3.24465, 3.126372, 3.575307, 3.438503, 3.370456, 3.160652
...
rmse_svm_new<-rmse(new_data$Min_Gap, predict_svm_new)#5.51186, 5.528604, 5.477125, 5.54174, 5.524035, 5.520426 
mae_svm_new<-mae(new_data$Min_Gap, predict_svm_new)#2.672365, 2.675192, 2.639413, 2.621238, 2.612381, 2.597676
rmse_svm_new
mae_svm_new
#newdata subset
predict_svm_new_subset<- predict(fit_svm_full,new_data_subset) 
rmse_svm_new_subset<-rmse(new_data_subset$Min_Gap, predict_svm_new_subset) #4.180932, 4.173172, 4.183047, 4.32544, 4.310544, 4.283404
mae_svm_new_subset<-mae(new_data_subset$Min_Gap, predict_svm_new_subset) #2.347398, 2.353471, 2.327629, 2.392655, 2.367369, 2.379497
rmse_svm_new_subset
mae_svm_new_subset
...
rmse_lm_new<-rmse(new_data$Min_Gap, predict_lm_new)# 6.19828, 6.202558, 6.080212, 6.307745, 6.234821, 6.313311 
mae_lm_new<-mae(new_data$Min_Gap, predict_lm_new)#3.425538, 3.496551, 3.303657, 3.370733, 3.352096, 3.432893
rmse_lm_new
mae_lm_new

#newdata subset
predict_lm_new_subset<- predict(fit_lm_full,new_data_subset) 
rmse_lm_new_subset<-rmse(new_data_subset$Min_Gap, predict_lm_new_subset) #4.438076, 4.563732, 4.457174, 4.666854, 4.632306, 4.468098
mae_lm_new_subset<-mae(new_data_subset$Min_Gap, predict_lm_new_subset) #2.923627, 2.992633, 2.833251, 2.98905, 2.96171, 2.941658 
rmse_lm_new_subset
mae_lm_new_subset
...
rmse_rf_new<-rmse(new_data$Min_Gap, predict_rf_new) #5.999946, 5.678038, 5.828507, 5.899021, 5.93217, 5.955163
mae_rf_new<-mae(new_data$Min_Gap, predict_rf_new)# 2.977484, 2.916052, 2.940546, 3.014469, 3.00836, 3.015434
rmse_rf_new
mae_rf_new
...
rmse_rf_new_subset<-rmse(new_data_subset$Min_Gap, predict_rf_new_subset) #4.204833, 4.201916, 4.320778, 4.769885, 4.727522, 4.595684
mae_rf_new_subset<-mae(new_data_subset$Min_Gap, predict_rf_new_subset) #2.560754, 2.589518, 2.583244, 2.805282, 2.778571, 2.82674
rmse_rf_new_subset
mae_rf_new_subset
...
rsme_ens_new<-rmse(new_data$Min_Gap, new_data$predict_ens)#5.710512, 5.639216, 5.586519, 5.920717, 5.596395, 6.045352
mae_ens_new<-mae(new_data$Min_Gap, new_data$predict_ens)# 2.99472, 2.913708, 2.877809, 3.023795, 2.861556, 3.076582
rsme_ens_new
mae_ens_new
...
rsme_ens_new_subset<-rmse(new_data_subset$Min_Gap, new_data_subset$predict_ens1) # 4.546548, 4.379895, 4.385226, 5.081976, 4.460845, 5.319244
mae_ens_new_subset<-mae(new_data_subset$Min_Gap, new_data_subset$predict_ens1) # 2.808789, 2.694864, 2.66885, 3.05219, 2.775607, 3.16412
rsme_ens_new_subset
mae_ens_new_subset
